...
function defaultGetAuth(hbp) {
    var token = hbp.auth.getJWTToken();
    // return the headers to the context so httpLink can read them
    // console.log(token)
    return token ? "Bearer " + token : "";
}
function default_1(context /* context contain for example { app, router, store, ssrContext, urlPath, redirect } from boot file */) {
    return {
        default: {
...
//# sourceMappingURL=apollo-client-config.js.map